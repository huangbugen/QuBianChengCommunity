...
{
    public partial class FileTypeRepository : BaseRepository<FileTypes>, IFileTypesRepository
    {
        public FileTypeRepository(FileDownloadSystemDbContext dbContext) : base(dbContext)
        {
        }
    }
}