<template>
    <div id="userLogin" v-if="settings != null">
        <div class="middle-pad" :style="{ backgroundImage: `url('${settings.backgroundImage}')` }">
            ...
            <div class="login-pad">
                ...
                <div class="login-options">
                    <p>
                        <el-input v-model="userNo" placeholder="请输入手机号码 或 Email" size="large">
                            <template #prepend>
                                <el-icon>
                                    <Lock />
                                </el-icon>
                    ...
                    <p>
                        <el-input size="large" type="password" show-password v-model="password" placeholder="请输入密码">
                            <template #prepend>
                                <el-icon>
                                    <Lock />
                                </el-icon>
                    ...
                    <p class="options">
                        ...
                        <span>&emsp;</span>
                        <router-link to="/changePassword" class="register-link">忘记密码</router-link>
                    </p>
                </div>
            </div>
        </div>
